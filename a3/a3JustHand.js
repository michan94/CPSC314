...
function initMotions() {
    ...
    handMotion.addKeyFrame(new Keyframe('straight',         0.0, [-4, 3,    0, 0, 0, 0, 0]));
    handMotion.addKeyFrame(new Keyframe('right finger curl',1.0, [-4, 5,   0, -90, -90, 0,0]));
    handMotion.addKeyFrame(new Keyframe('straight',         2.0, [-4, 3,    0, 0, 0, 0, 0]));
    handMotion.addKeyFrame(new Keyframe('left finger curl', 3.0, [-4, 3,   0, 0, 0, -90,-90]));
    handMotion.addKeyFrame(new Keyframe('straight',         4.0, [-4, 3,    0, 0, 0, 0, 0]));
    handMotion.addKeyFrame(new Keyframe('both fingers curl', 4.5, [-4, 3,   0, -90, -90, -90,-90]));
    handMotion.addKeyFrame(new Keyframe('straight',         6.0, [-4, 3,    0, 0, 0, 0, 0]));
}
...
function initObjects() {
    ...
    torus.position.set(0, 0, 0);   // translation
